...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    if (
        ...
        if (mysqli_num_rows($duplicateResult) > 0) {
            $errorMessage = "Another room already uses this room number.";
        }
    ...
    <main class="admin-main">
        ...
        <header class="page-header">
            ...
            <div>
                ...
                <span>
                    Update the selected room information.
                </span>

            </div>

            <a
                href="view_room.php?id=<?php echo $roomId; ?>"
                class="back-button"
            >
        ...
        <div class="form-layout">
            ...
            <section class="form-card">
                ...
                <div class="card-header">
                    ...
                    <p>
                        Change the required details and save your updates.
                    </p>
            ...
            <aside class="preview-card">
                ...
                <div class="card-header">
                    ...
                    <p>
                        Preview the updated room details.
                    </p>
                ...
                <div class="preview-content">
                    ...
                    <h3 id="previewRoomNumber"></h3>

                    <p id="previewRoomName"></p>

                    <div class="preview-list">

                        <div class="preview-item">
                            <span>Type</span>
                            <strong id="previewRoomType"></strong>
                        </div>

                        <div class="preview-item">
                            <span>Capacity</span>
                            <strong id="previewCapacity"></strong>
                        </div>

                        <div class="preview-item">
                            <span>Floor</span>
                            <strong id="previewFloor"></strong>
                        </div>
